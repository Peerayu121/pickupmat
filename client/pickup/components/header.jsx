    ...
    return (
        <>
            <header className="bg-gray-900">
                <nav aria-label="Global" className="mx-auto flex w-full justify-between p-6 lg:px-8">
                    <div className="flex lg:flex-1">
                        <a href="/" className="m-1.5 p-1.5">
                            <span className="text-white font-bold hover:text-gray-700">Stock List</span>
                        </a>
                    </div>
                    ...
                    <el-popover-group className="hidden lg:flex lg:gap-x-12">
                        <div className="relative">
                            ...
                            <el-popover id="desktop-menu-product" anchor="bottom" popover className="w-screen max-w-md overflow-hidden rounded-3xl bg-gray-800 outline-1 -outline-offset-1 outline-white/10 transition transition-discrete [--anchor-gap:--spacing(3)] backdrop:bg-transparent open:block data-closed:translate-y-1 data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in">
                                <div className="p-4">
                                ...
                                <div className="grid grid-cols-2 divide-x divide-white/10 bg-gray-700/50">
                                    <a href="#" className="flex items-center justify-center gap-x-2.5 p-3 text-sm/6 font-semibold text-white hover:bg-gray-700/50">
